...
r3y1_slot.set(SLOT_VALUES[1])

r3y1_spell = tk.StringVar(app)
r3y1_spell.set(SLOT_VALUES[0])
...
r3y2_slot.set(SLOT_VALUES[1])

r3y2_spell = tk.StringVar(app)
r3y2_spell.set(SLOT_VALUES[0])
...
r3y3_slot.set(SLOT_VALUES[1])

r3y3_spell = tk.StringVar(app)
r3y3_spell.set(SLOT_VALUES[0])
...
r3y4_slot.set(SLOT_VALUES[1])

r3y4_spell = tk.StringVar(app)
r3y4_spell.set(SLOT_VALUES[0])
...
r4y1_slot.set(SLOT_VALUES[1])

r4y1_spell = tk.StringVar(app)
r4y1_spell.set(SLOT_VALUES[0])
...
r4y2_slot.set(SLOT_VALUES[1])

r4y2_spell = tk.StringVar(app)
r4y2_spell.set(SLOT_VALUES[0])
...
r4y3_slot.set(SLOT_VALUES[1])

r4y3_spell = tk.StringVar(app)
r4y3_spell.set(SLOT_VALUES[0])
...
r4y4_slot.set(SLOT_VALUES[1])

r4y4_spell = tk.StringVar(app)
r4y4_spell.set(SLOT_VALUES[0])
