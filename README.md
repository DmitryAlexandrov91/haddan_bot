...
Проект основан на взаимодействии GUI приложения библиотеки tkinter с браузером Chrome библиотеки Selenium.
Впервые на практике применил многопоточность, научился управлять циклами событий, внедрять асинхронность внутрь синхронности.
Освоил базу ООП и основные принципы SOLID. 
Приложение разработано на последней версии python 3.13 в режиме совместимости с OS Windows 11 и Ubuntu 24.04.2 LTS
...
- bot_classes - Основные классы управления логикой работы приложения
    - driver_manager - Основа инициализации объекта webdriver, независим, может применяться в дальнейшем для других приложений
    - haddan_classes - классы управления логикой, непосредственно связанной с игрой haddan.ru

- tk_app - всё что связанно непосредственно с GUI приожением
...
Если не указать пароль от персонажа его придётся каждый раз вводить вручную при запуске приложения.
...
- прикрутить к проекту БД для хранения настроек игроков, карт и прочей информации
